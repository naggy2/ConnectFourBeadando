...
public:
    ...
    void drawText(int x_offset,int y_offset,int contourColor,int boxColor) const;
    void drawText(int x_offset,int y_offset,int contour_r,int contour_g,int contour_b,int boxColor) const;
